...
var nativeShare = function (elementNode, config) {
	...
	this.html_ = function() {
        var position = document.getElementById(this.elementNode);
        var html_ = '<div class="bshare-custom icon-medium">'+
	...
	this.is_QQBro = function(){
		...
		this.is_QQApp=function() {
				//var t = this.includeStr(UA, "qq"),
				//e = this.includeStr(UA, "nettype");
				//return t && e ? !0 : !1

			var a = UA.toLowerCase();
			if (a.match(/qq/i) == "qq" && a.match(/nettype/i) == "nettype" ) {
				return true
			} else {
				return false
			}
    ...
    this.init = function () {
        ...
        this.isloadqqApi();
		isQQBro = this.is_QQBro();
		isQQApp = this.is_QQApp();
		


		if ((isQQBro || isucBrowser) && !isWeixin && !isQQApp) {
            this.html();
        } else {
            this.html_();
        }
