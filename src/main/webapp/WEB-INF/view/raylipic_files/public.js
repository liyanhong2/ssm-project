...
function searchSelect(json){
    ...
    var btnUrl = json.btnUrl||'http://www.yoka.com/dna/m/search/';
    var req = Request();
    ...
    function toChange(){
        ...
        req.jsonp({
               ...
               success: function(str){
                      ...
                      var aLi = '';
                      for(var i=0;i<len;i++){
                          aLi += '<li title="'+arr[i][0]+'"><a target="_self" href="http://www.yoka.com/dna/m/t'+arr[i][2]+'">'+arr[i][0]+'<span>'+arr[i][1]+'</span></a></li>';
                      }
                      oUl.innerHTML = aLi;
                      show();
               }
...
function adInsert(json){
    ...
    function init(){
        ...
        aImg.onload = function(e){
            ...
            var html = '<a target="_blank" href="'+iLink+'"><img src="'+iSrc+'" alt=""></a><span class="close">鍏抽棴</span>';
            obj.innerHTML = html;
