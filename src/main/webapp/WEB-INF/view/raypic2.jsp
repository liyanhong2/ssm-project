    ...
    <div class="swiper-wrapper">
        ...
        <c:forEach items="${pics}" var="pic" varStatus="loop">
            <div class="swiper-slide">
                ...
                <div class="yhjwz">
                    <div class="yhjwz_t">${title}<span>${loop.index}</span>/10</div>
                    <div class="yhjwz_con">
        ...
        <%--<div class="swiper-slide">--%>
            ...
            <%--<div class="yhjwz">--%>
                ...
                <%--<div class="yhjwz_con">--%>
                    <%--<div id="yhj_wzgd_con_2" class="content"><br>--%>
                        <%--既然毛衣裙这么好穿，就再来一款，这件和上一件差不多款式，只是这次搭配上小白鞋和puzzlebag，也是毫无违和感，运动混搭风元气爆棚。--%>
                    <%--</div>--%>
                <%--</div>--%>
                <%--<div class="clearkit"></div>--%>
            <%--</div>--%>
